...
# Examples:
# bash utils/text_feature/extract_single_sentence_tokens.sh ${output_root} query query tvr_query_roberta_tokenized.jsonl MODEL_TYPE MODEL_NAME_OR_PATH --debug
output_root=$1
...
model_type=$5
model_name_or_path="${output_dir}/$6"
