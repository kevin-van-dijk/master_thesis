...
case ${dset_name} in
    tvr)
        ...
        if [[ ${ctx_mode} == *"sub"* ]] || [[ ${ctx_mode} == "sub" ]]; then
            ...
            desc_bert_path=/home/kevin/transformer_features_tvr/alberta-base-v2_epochs-0_no-gradient/query.h5
            sub_bert_path=/home/kevin/transformer_features_tvr/alberta-base-v2_epochs-0_no-gradient/sub_clip_level.h5
            sub_feat_size=768
